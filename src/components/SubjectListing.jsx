...
const SubjectListing = () => {
  const items = [
    ...
    { id: 3, image: 'https://s3.us-west-1.amazonaws.com/mindbowser.com-content/wp-content/uploads/2021/09/03091025/Best-Java-Integrated-Development-Environments-new.png', description: 'Programming for Problem Solving Practical List' },
  ...
  return (
    <div className="container mx-auto my-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ">
        {items.map((item) => (
          <div key={item.id} className="bg-white p-4 rounded-xl shadow-xl">
            <img
              src={item.image}
